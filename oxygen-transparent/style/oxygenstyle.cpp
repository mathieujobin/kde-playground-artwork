...
//         #endif
    ...
    bool Style::eventFilter( QObject *object, QEvent *event )
    {
        ...
        // cast to QWidget
        QWidget *widget = static_cast<QWidget*>(object);
        eventFilterWindow( widget, event );
    ...
    bool Style::eventFilterComboBoxContainer( QWidget* widget, QEvent* event )
    {
        switch( event->type() )
        {
            ...
            case QEvent::Paint:
            {
                ...
                // background
                helper().renderMenuBackground( &painter, paintEvent->rect(), widget, argbHelper().translucentColor( color, hasAlpha ) );
    ...
    bool Style::eventFilterWindow( QWidget* widget, QEvent* ev )
    {
        ...
        helper().renderWindowBackground( &p, paintEvent->rect(), widget, color );
        return true;
    ...
    bool Style::drawPanelMenuPrimitive( const QStyleOption* option, QPainter* painter, const QWidget* widget ) const
    {
        ...
        helper().renderMenuBackground( painter, r, widget, argbHelper().translucentColor( color, hasAlpha ) );
    ...
    bool Style::drawProgressBarGrooveControl( const QStyleOption* option, QPainter* painter, const QWidget* widget ) const
    {
        ...
        const QColor color( argbHelper().translucentColor( option->palette.color(QPalette::Window), widget ) );
        renderScrollBarHole( painter, option->rect, color, orientation );
    ...
    bool Style::drawScrollBarSliderControl( const QStyleOption* option, QPainter* painter, const QWidget* widget ) const
    {
        ...
        if( horizontal )
        {
            if( animated ) renderScrollBarHandle( painter, r, palette, Qt::Horizontal, mouseOver, hasAlpha, animations().scrollBarEngine().opacity( widget, SC_ScrollBarSlider ) );
            else renderScrollBarHandle( painter, r, palette, Qt::Horizontal, mouseOver, hasAlpha );

        } else {

            if( animated ) renderScrollBarHandle( painter, r, palette, Qt::Vertical, mouseOver, hasAlpha, animations().scrollBarEngine().opacity( widget, SC_ScrollBarSlider ) );
            else renderScrollBarHandle( painter, r, palette, Qt::Vertical, mouseOver, hasAlpha );
    ...
    //___________________________________________________________________________________
    bool Style::drawScrollBarAddPageControl( const QStyleOption* option, QPainter* painter, const QWidget* widget ) const
    {
        ...
        const QRect& r( option->rect );
        const QPalette& palette( option->palette );
        const QColor color( argbHelper().translucentColor( palette.color(QPalette::Window), widget ) );
    ...
    //___________________________________________________________________________________
    bool Style::drawScrollBarSubPageControl( const QStyleOption* option, QPainter* painter, const QWidget* widget ) const
    {
    ...
    void Style::renderScrollBarHandle(
        ...
        const Qt::Orientation& orientation, const bool& hover,
        const bool& hasAlpha,
        const qreal& opacity ) const
    {
        ...
        renderScrollBarHole(
            painter, holeRect,
            argbHelper().translucentColor( palette.color(QPalette::Window), hasAlpha ),
            orientation, horizontal ? TileSet::Vertical : TileSet::Horizontal );
