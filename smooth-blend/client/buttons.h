/****************************************************************************
** Image collection for project 'test'.
**
...
**
** Created: Sat Jan 29 15:01:59 2005
...
static struct EmbedImage {
    ...
    { 42, 41, 32, (const unsigned char*)image_10_data, 2017, 0, 0, TRUE, "splat.png" },
    { 42, 41, 32, (const unsigned char*)image_11_data, 1609, 0, 0, TRUE, "window_background.png" },
    { 41, 41, 32, (const unsigned char*)image_12_data, 1566, 0, 0, TRUE, "window_foreground.png" },
    { 0, 0, 0, 0, 0, 0, 0, 0, 0 }
};
...
class MimeSourceFactory_test : public QMimeSourceFactory
{
public:
    MimeSourceFactory_test() {}
    ~MimeSourceFactory_test() {}
...
void qInitImages_test()
{
    if ( !bfactory ) {
	bfactory = new MimeSourceFactory_test;
	QMimeSourceFactory::defaultFactory()->addFactory( bfactory );
    }
}

void qCleanupImages_test()
{
    if ( bfactory ) {
...
class StaticInitImages_test
{
public:
    StaticInitImages_test() { qInitImages_test(); }
#if defined(Q_OS_SCO) || defined(Q_OS_UNIXWARE)
    ~StaticInitImages_test() { }
#else
    ~StaticInitImages_test() { qCleanupImages_test(); }
#endif
};

static StaticInitImages_test staticImages;
