...
# handy arrays
set(PYTHON_VERSIONS "python;python2.4;python2.3;python2.2")
...
set(PYTHON_LIBS "boost_python-gcc-mt-1_33;boost_python-gcc-mt-1_33_1;boost_python;boost_python-gcc-mt-1_32;boost_python-gcc-mt-1_31")
              ...
              if(NOT _found)
                ...
                foreach(_pblib ${PYTHON_LIBS})
                  ...
                  if(NOT _found)
                    ...
                    set(CMAKE_REQUIRED_LIBRARIES "${_pblib}")
