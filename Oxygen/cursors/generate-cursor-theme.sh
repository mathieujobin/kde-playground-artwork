...
inkscape --without-gui --export-png=watch.png --export-background-opacity=0 --export-width=40 --export-height=40 ../../svgs/watch.svg > /dev/null
inkscape --without-gui --export-png=watch1.png --export-background-opacity=0 --export-width=40 --export-height=40 ../../svgs/watch1.svg > /dev/null
