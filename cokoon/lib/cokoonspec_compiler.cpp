...
int main(int argc, char **argv) {
    ...
    if (args.size() == 3) {
        ...
        if (!spec.loadSpecification(specFileName) ) {
            return 1;
        }
        ...
        hdr << "#ifndef " << spec.specName() << "_H" << endl;
        hdr << "#define " << spec.specName() << "_H" << endl;
        hdr << "namespace " << spec.specName() << " {" << endl;
        ...
        foreach(const SpecificationItem *i, spec.items()) {
        ...
        hdr << "}; // end class" << endl;
        hdr << "} // namespace" << endl;
        hdr << "#endif // " << spec.specName() << "_H" << endl;
